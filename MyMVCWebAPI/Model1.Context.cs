...
namespace MyMVCWebAPI
{
    ...
    public partial class MyDBJMAAEntities1 : DbContext
    {
        ...
        [DbFunction("MyDBJMAAEntities1", "GetTableMultiValuedFunction")]
        public virtual IQueryable<GetTableMultiValuedFunction_Result> GetTableMultiValuedFunction()
        {
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<GetTableMultiValuedFunction_Result>("[MyDBJMAAEntities1].[GetTableMultiValuedFunction]()");
        }
        ...
        [DbFunction("MyDBJMAAEntities1", "MyTableReturn")]
        public virtual IQueryable<MyTableReturn_Result> MyTableReturn(Nullable<int> parameter)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<MyTableReturn_Result>("[MyDBJMAAEntities1].[MyTableReturn](@parameter)", parameterParameter);
        }
